...
setwd("~/Documents/LHS/ICC/memoria_fis")
...
```{r funcionesPropias}
source("~/Documents/LHS/ICC/RCode/funcionesR.R")
...
dfpreval <- as.data.frame(vars)
dfpreval$vars <- str_replace(string = dfpreval$vars, pattern = "char_", replacement = "")
names(dfpreval) <- "patol"
#
patologias <- dfpreval$patol
